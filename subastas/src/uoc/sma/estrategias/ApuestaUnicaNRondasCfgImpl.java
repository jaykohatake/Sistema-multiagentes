 ...
 * entonces el valor de aceptaci�n de la puja ser� el de su precio de
 * reserva
 *
 * @author Rodolfo de Benito
 *
 */
public class ApuestaUnicaNRondasCfgImpl implements ICfgApuesta {
	...
	private CompradorHolandesaNRondasBehaviour comportamiento;

	public ApuestaUnicaNRondasCfgImpl(double incremento, double puja,
			double reserva, int rondas) {
		super();
